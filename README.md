...
* Capabilities to post images via URLs
...
$ git clone git@github.com:EzekielCarvalho/carvalho-camp.git
...
# If you encounter npm ERR! code EEXIST
...
You can make a new campground entry via the form.
